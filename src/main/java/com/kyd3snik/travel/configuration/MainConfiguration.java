...
class MainConfiguration {
    ...
    public CommandLineRunner test(HotelRepository hotelRepository, HotelRoomRepository hotelRoomRepository,
        ...
        return args -> {
            ...
            City city1 = cityRepository.save(new City(0, "Москва", country1, List.of(entertainment1, entertainment2, entertainment6, entertainment8), Collections.emptyList()));
            City city2 = cityRepository.save(new City(0, "Сочи", country1, List.of(entertainment4, entertainment6, entertainment7), Collections.emptyList()));
            City city3 = cityRepository.save(new City(0, "Берлин", country2, List.of(entertainment1, entertainment2, entertainment8), Collections.emptyList()));
            City city4 = cityRepository.save(new City(0, "Воронеж", country1, List.of(entertainment1, entertainment2), Collections.emptyList()));
            City city5 = cityRepository.save(new City(0, "Рабат", country3, List.of(entertainment2, entertainment4, entertainment6), Collections.emptyList()));
            City city6 = cityRepository.save(new City(0, "Анкара", country4, List.of(entertainment2, entertainment6, entertainment8), Collections.emptyList()));
            City city7 = cityRepository.save(new City(0, "Измир", country4, List.of(entertainment2, entertainment6, entertainment4), Collections.emptyList()));
